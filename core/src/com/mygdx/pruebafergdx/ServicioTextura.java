...
public class ServicioTextura {
	...
	public static void iniciarTexturas(Texture spriteSheet) {
		...
		TILE_CONTAINER_MAP.put(Tile.MAN, new TileContainer(Tile.MAN, 129, 1, spriteSheet));
		TILE_CONTAINER_MAP.put(Tile.PLAYER, new TileContainer(Tile.PLAYER, 129, 1, spriteSheet));
	}
